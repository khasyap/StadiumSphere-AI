...
let UserController = class UserController extends resource_controller_1.ResourceController {
    constructor(service) {
        super(service, 'User');
    }
    list() {
...
exports.UserController = UserController = __decorate([
    ...
    __param(0, (0, common_1.Inject)(application_1.USER_APPLICATION_SERVICE)),
